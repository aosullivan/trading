"""Deterministic v1.9 EMA-family hardening prototypes."""
...
_SPEC_PATH = _FIXTURES / "focus_basket_ema_hardening_prototypes.json"
_CANONICAL_SPEC_PATH = _FIXTURES / "focus_basket_benchmarks.json"


@pytest.fixture
def ema_hardening_spec():
...
def test_ema_hardening_candidates_match_frozen_outcomes(
    app,
    client,
    focus_chart_spec,
    focus_ohlcv_full,
    ...
    candidate = ema_hardening_spec["candidates"][candidate_index]
...
def test_ema_equity_confirmed_is_the_best_balanced_first_hardening_candidate(
    app,
    client,
    focus_chart_spec,
    focus_ohlcv_full,
    ...
    by_key = {}
    for candidate in ema_hardening_spec["candidates"]:
