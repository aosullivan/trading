"""Deterministic v1.10 crypto-focused EMA-family prototypes."""
...
_SPEC_PATH = _FIXTURES / "focus_basket_ema_crypto_prototypes.json"
...
def test_ema_crypto_candidates_match_frozen_outcomes(
    app,
    client,
    focus_chart_spec,
    focus_ohlcv_full,
    ...
    candidate = ema_crypto_spec["candidates"][candidate_index]
...
def test_ema_equity_confirmed_remains_best_current_candidate_after_crypto_sweep(
    app,
    client,
    focus_chart_spec,
    focus_ohlcv_full,
    ...
    by_key = {}
    for candidate in ema_crypto_spec["candidates"]:
